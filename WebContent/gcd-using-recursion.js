...
function initIntroJS() {
				...
				$("#informationDiv ul li:last-child").hide().fadeIn(500, function() {
					...
					$("#informationDiv ul li:last-child").hide().fadeIn(500, function() {
						...
						$("#informationDiv ul li:last-child").hide().fadeIn(500, function() {
							...
							$("#informationDiv ul li:last-child").hide().fadeIn(500, function() {
								$("#informationDiv ul").append("<li>For example, using the above formula GCD of <span class='ct-code-b-green'>54</span> " 
										+ "and <span class='ct-code-b-green'>24</span> is calculated as:</li>");
								...
								$("#informationDiv ul li:last-child").hide().fadeIn(500, function() {
									$("#informationDiv ul li:last-child").append("<div style='font-weight: bold'>gcd(54, 24)</div>");
									$("#informationDiv ul li:last-child > div").append("<span>&nbsp = gcd(24, 54 % 24)</span>").find("span").hide().fadeIn(500, function() {
										setTimeout(function() {
											$("#informationDiv ul li:last-child").append("<div style='font-weight: bold'>&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp; = gcd(24, 6)</div>").find("div").last().hide().fadeIn(500, function() {
												setTimeout(function() {
													introjs.refresh();
													$("#informationDiv ul li:last-child").append("<div style='font-weight: bold'>&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp; = gcd(6, 24 % 6)</div>").find("div").last().hide().fadeIn(500, function() {
														setTimeout(function() {
															introjs.refresh();
															$("#informationDiv ul li:last-child").append("<div style='font-weight: bold'>&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp; = gcd(6, 0)</div>").find("div").last().hide().fadeIn(500, function() {
																setTimeout(function() {
																	introjs.refresh();
																	$("#informationDiv ul li:last-child").append("<div style='font-weight: bold'>&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp; = 6</div>").find("div").last().hide().fadeIn(500, function() {
																		introjs.refresh();
																		$("#informationDiv ul").append("<li>For more information on the formula <a href='https://en.wikipedia.org/wiki/Greatest_common_divisor#Using_Euclid.27s_algorithm' target='_blank'>click here</a>.</li>");
																		$("#informationDiv ul li:last-child").hide().fadeIn(500, function() {
																			$("#informationDiv ul li:last-child").append("<a class='introjs-button user-btn opacity00' onclick='userNextStep()'>Next</a>");
																			introjs.refresh();
	...
	function keyDownEvent() {
		$("[contenteditable=true]").on("keydown", function(e) {
			...
			if ($(this).text().length > max) {
				$('.introjs-tooltiptext').append("<div class='errMsg'><br/>Max Length 2 digits only.</div>");
				e.preventDefault();
			}
		});
	...
	function reArrangeArrows(flag, callBackFunction) {
		...
		for (var i = 0; i < idsArr.length - 1; i++) {
			...
			x1 = Math.abs(x1 / ($("#mySvg").width() / 100));
		...
		$("#mySvg .svg-line").eq($("#mySvg .svg-line").length - 3).attr("id", "arrow1").css({"display" : "none", "stroke" : "blue"});
		$("#mySvg .svg-line").eq($("#mySvg .svg-line").length - 2).attr("id", "arrow2").css({"display" : "none", "stroke" : "blue"});
		$("#mySvg .svg-line").eq($("#mySvg .svg-line").length - 1).attr("id", "arrow3").css({"display" : "none", "stroke" : "blue"});
		if (flag) {
	...
	function valueReplaceEffect() {
		...
		var l1 = $(".returned-val").eq(0).css("z-index", "1").offset();
		$("#dummySpan").offset({
			"top" : l1.top,
			"left" : l1.left
		...
		$(".returned-val").eq(0).css("position", "relative");
