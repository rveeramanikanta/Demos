		...
		introjs.onafterchange(function(targetElement) {
			...
			case "informationDiv":
				...
				$("#informationDiv ul li:last-child").hide().fadeIn(500, function() {
					...
					$("#informationDiv ul li:last-child").hide().fadeIn(500, function() {
						$("#informationDiv ul").append("<li>The greatest common divisor of <span class='ct-code-b-green'>54</span>" 
								+ " and <span class='ct-code-b-green'>24</span> is calculated as:<br/>" 
								+ "<div>&emsp;The divisors of <span class='ct-code-b-green'>54</span> are : " 
								+ "<span class='ct-code-b-red'>1</span>, <span class='ct-code-b-red'>2</span>, <span class='ct-code-b-red'>3</span>" 
								+ ", <span class='ct-code-b-red'>6</span>, 9, 18, 27, 54 " 
								+ "and the divisors of <span class='ct-code-b-green'>24</span> are : " 
								+ " <span class='ct-code-b-red'>1</span>, <span class='ct-code-b-red'>2</span>, " 
								+ "<span class='ct-code-b-red'>3</span>, 4, <span class='ct-code-b-red'>6</span>, 8, 12, 24.</div>" 
								+ "<div>&emsp;The numbers that these two lists share in common are the common divisors of " 
								+ "<span class='ct-code-b-green'>54</span>" 
								+ " and <span class='ct-code-b-green'>24</span> : " 
								+ "<span class='ct-code-b-red'>1</span>, " 
								+ "<span class='ct-code-b-red'>2</span>, " 
								+ "<span class='ct-code-b-red'>3</span>, " 
								+ "<span class='ct-code-b-red'>6</span>.</div> " 
								+ "&emsp;So <span class='ct-code-b-green'>gcd(54,24)</span> = <span class='ct-code-b-green'>6</span>.</li>");
						$("#informationDiv ul li:last-child").hide().fadeIn(500, function() {
