		...
		case "cCode":
			...
			$(".introjs-helperLayer").one("transitionend", function() {
				...
				var text = "In the below code we will learn how a recursion function call "
					+ "will works by using an example of the <span class='ct-code-b-yellow'>factorial</span> function.";
...
function createMainStack() {
	$("#stackBody").prepend("<div class='panel panel-primary opacity00'>" 
			...
			+ "<div><span id='mainStackPrintf'>printf(\"%d! = %d\", number, fact_value);</span></div></div></div>");
